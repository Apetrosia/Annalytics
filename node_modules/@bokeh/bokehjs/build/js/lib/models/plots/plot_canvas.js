...
export class PlotView extends LayoutDOMView {
    ...
    _computed_style = new InlineStyleSheet("", "computed");
    stylesheets() {
    ...
    *children() {
    ...
    async lazy_initialize() {
        ...
        this.inner_top_panel = this._element_views.get(this._inner_top_panel);
        this.inner_bottom_panel = this._element_views.get(this._inner_bottom_panel);
        this.inner_left_panel = this._element_views.get(this._inner_left_panel);
        this.inner_right_panel = this._element_views.get(this._inner_right_panel);
    ...
    _update_layout() {
        ...
        const { outer_above, outer_below, outer_left, outer_right, inner_above, inner_below, inner_left, inner_right, } = this._compute_layout_panels();
        ...
        this.layout = layout;
        const wrapper = (flex_direction, children) => {
            return div({
                style: {
                    display: "flex",
                    flex_direction,
        ...
        const needs_layout = (() => {
            if (this._needs_layout) {
                ...
                for (const panel of this.model.side_panels) {
                    const view = this.renderer_views.get(panel); // TODO
                    if (view != null) {
    ...
    *_compute_renderers() {
        ...
        yield* renderers;
        yield* [...above, ...below, ...left, ...right, ...center]; // TODO
        if (this._title != null) {
            yield this._title;
        }
        if (this._toolbar != null) {
